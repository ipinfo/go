...
type Core struct {
	...
	CountryContinent CountryContinent `json:"country_continent,omitempty" csv:"country_continent_,inline"`
...
func (v *Core) setCountryName() {
	if v.Country != "" {
		...
		v.CountryContinent.Code = GetCountryContinentCode(v.Country)
		v.CountryContinent.Name = GetCountryContinentName(v.Country)
	}
